...
def create_interactive_graph(
    nodes: List[Dict], edges: List[Dict], title: str = "Interactive Graph"
) -> str:
    """
    ...
    try:
        ...
        for node in nodes:
            net.add_node(
                node["id"], label=node["label"], title=node.get("title", node["label"])
            )
...
def create_comparison_chart(
    data: List[Dict], x_key: str, y_key: str, title: str = "Comparison Chart"
) -> str:
    """
