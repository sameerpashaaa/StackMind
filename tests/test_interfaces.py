...
from interfaces.cli import ProblemSolverCLI


class TestCommandLineInterface(unittest.TestCase):
    """Test case for the command-line interface."""

    @patch("interfaces.cli.ProblemSolverAgent")
    def setUp(self, mock_agent_class):
        ...
        self.cli = ProblemSolverCLI(self.mock_settings)

    @patch("interfaces.cli.print")
    def test_process_text_input(self, mock_print):
        """Test that the CLI processes text input correctly."""
        self.cli._process_text_input("What is 2+2?")

        self.mock_agent.solve_problem.assert_called_once()
        mock_print.assert_called()

    @patch("interfaces.cli.print")
    def test_display_solution(self, mock_print):
        ...
        self.cli._print_solution(solution)
...
class TestAPIInterface(unittest.TestCase):
    ...
    @patch("interfaces.api.app.state.agent", create=True)
